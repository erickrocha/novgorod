...
const Radio: React.FC<RadioProps> = ({
  ...
  return (
    ...
    >
      ...
      />
      <span
        className={`flex h-5 w-5 items-center justify-center rounded-full border-[1.25px] transition-colors ${
          checked
            ? "border-brand-500 bg-brand-500"
            : "bg-transparent border-gray-200 hover:border-gray-300 dark:border-gray-700"
        } ${
          disabled
