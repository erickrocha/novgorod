        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(pk_auto(SkuAttributeValue::Id).big_integer())
                    .col(uuid_uniq(SkuAttributeValue::Uuid))
                    .col(big_integer(SkuAttributeValue::TenantId))
                    .col(big_integer(SkuAttributeValue::ProductId))
                    .col(big_integer(SkuAttributeValue::SkuId))
                    .col(big_integer(SkuAttributeValue::ProductAttributeId))
                    .col(big_integer(SkuAttributeValue::AttributeId))
                    .col(big_integer(SkuAttributeValue::AttributeValueId))
                    ...
                    .col(string_len_null(SkuAttributeValue::UpdatedBy, 255))
                    .index(
                        Index::create()
