...
#[openapi(
    ...
    paths(
        ...
        endpoints::orders_endpoint::add,
        endpoints::orders_endpoint::update,
        endpoints::order_item_endpoint::list_all,
        endpoints::order_item_endpoint::paged,
        endpoints::order_item_endpoint::get_by_id,
        endpoints::order_item_endpoint::add,
        endpoints::order_item_endpoint::update,
        endpoints::order_status_history_endpoint::list_all,
        endpoints::order_status_history_endpoint::paged,
        endpoints::order_status_history_endpoint::get_by_id,
        endpoints::order_status_history_endpoint::add,
    ...
    components(
        schemas(
            ...
            endpoints::json::orders_json::OrdersInputJson,
